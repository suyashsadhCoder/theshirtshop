...
{
    public class NewCheckBox: Xamarin.Forms.View
    {
        ...
        public static BindableProperty TextParameterProperty = BindableProperty.Create(nameof(TextParameter), typeof(string), typeof(Checkbox), null);
        ...
        public string TextParameter
        {
            get
            {
                return (string) GetValue(TextParameterProperty);
            }
            set
            {
                SetValue(TextParameterProperty, value);
            }
        }
